...
namespace WebApplication.Controllers
{
    public class CustomerController : Controller
    {
        ...
        {
            var baseDbContext = _context.Customers.Include(c => c.PhoneBook);
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,DateOfBirth,AFM,Description,PhoneBookId,Id,CreatedOn")] Customer customer)
        {
