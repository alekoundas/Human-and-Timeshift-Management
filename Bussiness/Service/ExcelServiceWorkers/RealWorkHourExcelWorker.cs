...
{
    public class RealWorkHourExcelWorker : ExcelService<RealWorkHour>
    {
        private BaseDatawork _baseDatawork { get; }

        public RealWorkHourExcelWorker(BaseDbContext BaseDbContext) : base(BaseDbContext)
        {
        ...
        public RealWorkHourExcelWorker ValidateHoursInTimeshift<TEntity>(List<TEntity> exportedInstances, out string error)
        {
        ...
        public RealWorkHourExcelWorker ValidateSameTimeshift<TEntity>(List<TEntity> exportedInstances, out string error)
        {
            error = "";
        ...
        public RealWorkHourExcelWorker ValidateEmployeeInTimeshift<TEntity>(List<TEntity> exportedInstances, out string error)
        {
            var hasValidationError = false;
            error = "";
            foreach (var exportedInstance in exportedInstances)
