...
namespace DataAccess.Migrations.BaseDb
{
    ...
    [Migration("20210915192904_LogTablesAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.Base.LogEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccess.Models.Base.LogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccess.Models.Entity.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ActingUserFullName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DataAccess.Models.Entity.Log", b =>
                {
                    b.HasOne("DataAccess.Models.Base.LogEntity", "LogEntity")
                        .WithMany("Logs")
                        .HasForeignKey("LogEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataAccess.Models.Base.LogType", "LogType")
                        .WithMany("Logs")
