...
{
    public class TimeShiftValidateUnique : ValidationAttribute
    {
        private readonly string _currentPropertyName;
        public TimeShiftValidateUnique(string currentPropertyName)
        {
            ...
            object value, ValidationContext validationContext)
        {
            ...
            if (baseDataWork.TimeShifts.Any(filter))
            {
